export const enSpeedLimiters = {
  ...
  "speedLimiters.verify.section.vehicle": "Vehicle details",
  "speedLimiters.verify.section.limiter": "Speed limiter details",
  "speedLimiters.verify.section.validity": "Certificate validity",
  "speedLimiters.verify.makeModel": "Make & model",
  "speedLimiters.verify.year": "Year of manufacture",
  "speedLimiters.verify.chassis": "Chassis no.",
  "speedLimiters.verify.engine": "Engine no.",
  "speedLimiters.verify.limiterType": "Type of speed limiter",
