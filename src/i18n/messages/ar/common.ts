...
export const arCommon: Translation<typeof enCommon, "ar"> = {
  ...
  "nav.gpsTracking": "تتبع GPS",
  "nav.driverBehavior": "سلوك السائقين",
  "nav.trips": "تخطيط الرحلات",
  "nav.dispatch": "الإرسال",
  "nav.workshop": "الورشة",
  "nav.predictive": "الصيانة التنبؤية",
  "nav.insurance": "التأمين",
  "nav.incidents": "الحوادث",
  "nav.regulatory": "الامتثال التنظيمي",
  "nav.tms": "النقل (TMS)",
  ...
  "nav.customerPortal": "بوابة العملاء",
  "nav.vendorPortal": "بوابة الموردين",
  "nav.analytics": "تحليلات الأعمال",
  "nav.documents": "المستندات",
  "nav.notifications": "الإشعارات",
  "nav.automation": "الأتمتة",
  "nav.integrations": "التكاملات",
  "nav.iot": "أجهزة إنترنت الأشياء",
  "nav.security": "التدقيق والأمان",
  ...
  "nav.section.logistics": "الخدمات اللوجستية",
  "nav.section.finance": "المالية",
  "nav.section.people": "الموارد البشرية",
