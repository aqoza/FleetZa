...
export const arSpeedLimiters: Record<keyof typeof enSpeedLimiters, string> = {
  ...
  "speedLimiters.verify.section.vehicle": "بيانات المركبة",
  "speedLimiters.verify.section.limiter": "بيانات محدد السرعة",
  "speedLimiters.verify.section.validity": "صلاحية الشهادة",
  "speedLimiters.verify.makeModel": "الصنع والطراز",
  "speedLimiters.verify.year": "سنة الصنع",
  "speedLimiters.verify.chassis": "رقم الشاسيه",
  "speedLimiters.verify.engine": "رقم المحرك",
  "speedLimiters.verify.limiterType": "نوع محدد السرعة",
